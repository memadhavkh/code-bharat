		...
		<div className='text-white z-40'>
			<div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
				<div className='flex min-h-screen items-center justify-center px-4'>
					...
					>
						<div className='fixed inset-0 bg-colors-dark-gray-8 opacity-60'></div>
					</div>
					...
					<div className='my-8 inline-block min-w-full transform rounded-[13px] text-left transition-all bg-overlay-3 md:min-w-[420px] shadow-level4 shadow-lg p-0 bg-[rgb(40,40,40)] w-[600px] !overflow-visible opacity-100 scale-100'>
						{/* setting header */}
						<div className='flex items-center px-5 py-4 text-lg font-medium border-b-2 border-colors-dark-divider-border-2'>
							Settings
							<button
						...
						<div className='px-6 pt-4 pb-6'>
							<div className='mt-6 flex justify-between first:mt-0'>
								<div className='w-[340px]'>
									...
									<h3 className='text-colors-dark-label-2 mt-1.5'>
								...
								<div className='w-[170px]'>
									<div className='relative'>
										<button
											...
											className='flex cursor-pointer items-center rounded px-3 py-1.5 text-left focus:outline-none whitespace-nowrap bg bg-colors-dark-fill-3 hover:bg-colors-dark-fill-2 active:bg-colors-dark-fill-3 w-full justify-between'
											type='button'
										>
											{fontSize}
											<BsChevronDown />
										...
										{settings.dropdownIsOpen && (
											<ul
												className='absolute mt-1 max-h-56 overflow-auto rounded-lg p-2 z-50 focus:outline-none shadow-lg   w-full bg-colors-dark-layer-1'
												style={{
...
const SettingsListItem: React.FC<SettingsListItemProps> = ({ fontSize, selectedOption, handleFontSizeChange }) => {
	return (
		<li className='relative flex h-8 cursor-pointer select-none py-1.5 pl-2 text-colors-dark-label-2 dark:text-colors-dark-label-2 hover:bg-colors-dark-fill-3 rounded-lg'>
			<div
			...
			<span
				className={`text-blue-400 dark:text-colors-dark-blue-s flex items-center pr-2 ${
