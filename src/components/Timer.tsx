...
const Timer = () => {
	...
	return (
		<div>
			{showTimer ? (
				<div className='flex items-center space-x-2 bg-colors-dark-fill-3 p-1.5 cursor-pointer rounded hover:bg-colors-dark-fill-2'>
				...
				<div
					className='flex items-center p-1 h-8 hover:bg-colors-dark-fill-3 rounded cursor-pointer'
